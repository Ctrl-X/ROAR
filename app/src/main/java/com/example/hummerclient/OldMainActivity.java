...
import com.example.hummerclient.databinding.OldActivityMainBinding;
...
public class OldMainActivity extends AppCompatActivity implements MotorActionnable, ArduinoListener {

    private static String TAG = "ROAR";
    private OldActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = OldActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void startUdpTransmission() {
        ...
        Log.i(TAG, this.isServer ? " Server" : "Client" + " is now Running...");
    ...
    private void processClientResponse(String[] dataSet) {
        ...
        switch (action) {
            case "IP":
                ...
                Log.i(TAG, " updated client IP to " + value);
                break;
        }
    }
